...
import styles from "./JoinWaitList.css";
  ...
  return (
    <>
      ...
      <FormControl variant="standard" sx={{margin:"30px auto"}}>
        ...
        <InputLabel htmlFor="input-with-icon-adornment" sx={{fontSize:"20px",marginTop:"-10px",color: "#adb4c7"}}>
        Username (avoid special character)
        </InputLabel>
        <Input
          id="input-with-icon-adornment"
          sx={{borderBottom:"1px solid rgb(196 196 196)"}}
      ...
      <FormControl variant="standard" sx={{margin:"30px auto"}}>
        ...
        <Box
          component="form"
          sx={{
            "& .MuiTextField-root": { m: 2, width: "15ch" },paddingLeft:"0px"
          }}
          noValidate
          autoComplete="off"
        >
        <h4 style={{fontSize:"14px",color:"rgba(0, 0, 0, 0.6)",fontWeight:"400",color:"#adb4c7"}}>Domain</h4>
          <TextField
  ...
  return (
    <>
      <Row style={{
        ...
        <h4  style={{ fontWeight: "bold", fontSize: 20, color: "black",padding:0 }}>
          Social Media Links
        </h4>
        <h4 style={{ marginTop: 20, fontSize: 15, fontWeight: 100,padding:0 }}>
          It is mandatory to provide atleast one social media handle and its
      ...
      <Row style={{
        ...
        <Col xs={3} style={{ marginLeft:5,width:"30%", }}>
          <Row>
            <FormControl variant="standard" sx={{margin:"30px auto"}}>
...
export { ProfileDetails, SocialMedialLinks };
