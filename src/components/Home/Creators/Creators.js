      ...
      <Container>
        <Row>
          <div className="creator-title">
            <p>
              creators & entrepreneurs as investors who think this is a{" "}
              <span style={{ fontWeight: 700, color: "rgb(255, 86, 177)" }}>
                {" "}
                smashing idea
              </span>
              .
      ...
      <article class="wrapper">
        <div class="marquee">
          <div class="marquee__group">
            <img
              src="https://www.hypd.store/img/Bhuvam-bam.cf85a9e2.png"
              width="280px"
              height="280px"
            />
            <img
